import 'dart:ffi';
import 'package:cf_app/components/error_screen.dart';
import 'package:cf_app/drawer.dart';
import 'package:cf_app/screens/data/bar_chart_data.dart';
import 'package:cf_app/screens/data/general_data.dart';
import 'package:cf_app/screens/data/pie_data.dart';
import 'package:cf_app/screens/widgets/bar_groups.dart';
import 'package:cf_app/screens/widgets/line_chart_spots.dart';
import 'package:cf_app/screens/widgets/pie_chart_sections.dart';
...
import 'package:cf_app/screens/singleUserScreenModels/ratingChanges.dart' as Rating;
import 'package:cf_app/screens/singleUserScreenModels/submissions.dart' as Sub;
import 'package:cf_app/screens/singleUserScreenModels/userInfo.dart' as Info;
...
class _SingleUserDetailsPageState extends State<SingleUserDetailsPage> {
  ...
  void getdata() async {
    ...
    var url3 = Uri.https("www.codeforces.com", "/api/user.rating?handle=${widget.handle}");
    //.....................................................................
              ...
              child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text("${userinfo.city}",style: TextStyle(color: Colors.blue,decoration: TextDecoration.underline),),
                        const Text(", ",style: TextStyle(color: Colors.black),),
                        Text("${userinfo.country}",style: TextStyle(color: Colors.blue,decoration: TextDecoration.underline),),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    Row(
                      children: [
                        Text("Friend of: ",style: TextStyle(color: Colors.black),),
                        Text("${userinfo.friendOfCount}",style: TextStyle(color: Colors.black),),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text("${userinfo.contribution}",style: TextStyle(color: Colors.green),),
                        // Text(" users",style: TextStyle(color: Colors.black),),
                      ],      
                    ),
                  ],
